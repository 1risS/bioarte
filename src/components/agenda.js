...
const eventsPerDay = [
  ...
  [
    ...
    {
      time: "18:00",
      title: "Conversatorio sobre Biotecnología en Salud Humana",
      speaker: "Academia",
      desc:
  ...
  [
    ...
    {
      time: "18:00",
      title: "Salud y Reproducción Animal",
      speaker: "Biotecnología",
      desc:
    ...
    {
      time: "18:50",
      title: "Desarrollo de una obra colectiva de BioArte por Zoom",
      speaker: "Performance",
      desc:
    ...
    {
      time: "19:00",
      title: "Una historia [de la timeline] del BioArte",
      speaker: "Arte",
      desc:
  ...
  [
    {
      time: "15:00",
      title: "Biomateriales, Biosensado y Biosonorización",
      speaker: "Arte",
      desc:
    ...
    {
      time: "16:00",
      title: "Estado del arte del mejoramiento de cultivos y transgénicos",
      speaker: "Biotecnología",
      desc:
        "María Luz Zapiola - Ingeniera en Producción Agropecuaria egresada de la UCA. Doctora en Filosofía (PhD) y Máster en Ciencias (MSc), de Oregon State University, EEUU. Responsable del Área Técnica de ArgenBio.",
    },
    ...
    {
      time: "18:40",
      title: "UADE: El Himno Nacional en una bacteria",
      speaker: "Academia",
      desc:
  ...
  [
    ...
    {
      time: "16:40",
      title: "El estado del arte en la Bioinformática",
      speaker: "Academia",
      desc:
    ...
    {
      time: "17:00",
      title: "BioArte en las Universidades",
      speaker: "Academia",
      desc:
